package com.example.practica2googlemaps;
...
import com.example.practica2googlemaps.WebServices.Asynchtask;
import com.example.practica2googlemaps.WebServices.WebService;
...
public class MainActivity extends AppCompatActivity  implements OnMapReadyCallback, Asynchtask
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lat = -1.02313;
        lng = -79.459561;
        radio = 1f; // mejor indicar que es float
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        CameraUpdate camUpd1 =
                CameraUpdateFactory
                        .newLatLngZoom(new LatLng(-1.0227457978094603, -79.46047378014322), 16);
    ...
    private void updateInterfaz(){
        ...
        WebService ws= new WebService(
                "https://turismo.quevedoenlinea.gob.ec/lugar_turistico/json_getlistadoMapa?lat="
